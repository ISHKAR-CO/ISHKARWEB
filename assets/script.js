...
$(document).ready(function(){
	/* index js */
  headerFixed($(this).scrollTop());  bannerHeight();
  var prevArrow = '<button class="custom-arrow slick-prev slick-arrow" aria-label="Previous" type="button" aria-disabled="false"><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="//cdn.shopify.com/s/files/1/0318/4839/8907/t/1/assets/BlackArrowLeft_300x.png?v=4474757943884721440" alt="Previous Arrow" width="auto" height="auto" /></button>', nextArrow = '<button class="custom-arrow slick-next slick-arrow" aria-label="Next" type="button" aria-disabled="false"><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="//cdn.shopify.com/s/files/1/0318/4839/8907/t/1/assets/BlackArrowRight_300x.png?v=17239851723819549468" alt="Next Arrow" width="auto" height="auto" /></button>';
  
  $('.hfp-grid-slider').slick({
    dots: false, infinite: false, speed: 650, slidesToShow: 4, slidesToScroll: 1, prevArrow : prevArrow, nextArrow : nextArrow, responsive: [ { breakpoint: 1201, settings: { slidesToShow: 3 } }, { breakpoint: 768, settings: { slidesToShow: 2 } }, { breakpoint: 375, settings: { slidesToShow: 1 } } ] })
  /* index js end */  
