...
var ajaxCart = (function(module, $){
  ...
  updateCountPrice = function (cart) {
    ...
    if ($cartCostSelector) { $cartCostSelector.html(Shopify.formatMoney(cart.total_price, '')); }
  ...
  buildCart = function(cart){ /* Start with a fresh cart div*/ $cartContainer.empty();
    /* Show empty cart*/ if (cart.item_count === 0) {
      $cartContainer
        .append('<h4 class="empty_cart_slide_cls text-center secondary-font">' + "Your cart is currently empty." + '</h5>');
    ...
    data = { items: items, note: cart.note, totalPrice: Shopify.formatMoney(cart.total_price, shop_currency), totalCartDiscount: cart.total_discount === 0 ? 0 : "translation missing: en.cart.general.savings_html".replace('[savings]', theme.Currency.formatMoney(cart.total_discount, settings.moneyFormat)) };
